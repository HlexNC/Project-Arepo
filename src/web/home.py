...
def run():
    ...
    st.write("""
    **Project Apero** is a comprehensive web application designed to provide personalized health recommendations and data insights. Navigate through the sidebar to explore different functionalities:
